...
void DrawGridline (CGContextRef context, CGFloat x, CGFloat y, CGColorRef color, CGFloat width)
{
...
void DrawGridlines(CGContextRef context, CGFloat x, CGFloat width, CGFloat delta)
{
    CGFloat start = 32 - delta;
    CGFloat y = start;

    DrawGridline(context, x, y, [UIColor blackColor].CGColor, width);
    
    y+=16; 
    start-=16;
    DrawGridline(context, x, y, CreateDeviceRGBColor(0.3, 1.0, 0.7, 1.0), width);
    DrawGridline(context, x, start, CreateDeviceRGBColor(0.3, 1.0, 0.7, 1.0), width);
    y+=16;
    start-=16;
    DrawGridline(context, x, y, [UIColor greenColor].CGColor, width);
    DrawGridline(context, x, start, [UIColor greenColor].CGColor, width);
    y+=16;
    start-=16;
    DrawGridline(context, x, y, [UIColor yellowColor].CGColor, width);
    DrawGridline(context, x, start, [UIColor yellowColor].CGColor, width);
    y+=16;
    start-=16;
    DrawGridline(context, x, y, [UIColor orangeColor].CGColor, width);
    DrawGridline(context, x, start, [UIColor orangeColor].CGColor, width);
    y+=16;
    start-=16;
    DrawGridline(context, x, y, [UIColor redColor].CGColor, width);
    DrawGridline(context, x, start, [UIColor redColor].CGColor, width);
...
-(id)init
{
	...
	if(self != nil)
	{
		...
		layer.bounds = CGRectMake(0.0, -104.0, 32.0, 112.0);
...
-(void)drawLayer:(CALayer*)l inContext:(CGContextRef)context
{
	...
	// Draw the grid lines
	DrawGridlines(context, 0.0, 32.0, 48);
	...
	{
        lines[i*2].x = i;
		lines[i*2].y = -(sqrt(pow(xhistory[i],2)+pow(yhistory[i],2)+pow(zhistory[i],2))) * 16.0;
        lines[i*2+1].x = i + 1;
		lines[i*2+1].y = -(sqrt(pow(xhistory[i+1],2)+pow(yhistory[i+1],2)+pow(zhistory[i+1],2))) * 16.0; 
...
-(void)drawRect:(CGRect)rect
{
	...
	// Draw the grid lines
	DrawGridlines(context, 26.0, 6.0, 0);

	// Draw the text
	UIFont *systemFont = [UIFont systemFontOfSize:12.0];
	[[UIColor blackColor] set];
    
	[@"+5.0" drawInRect:CGRectMake(2.0, -56.0, 24.0, 16.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	[@"+4.0" drawInRect:CGRectMake(2.0, -40.0, 24.0, 16.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	[@"+3.0" drawInRect:CGRectMake(2.0, -24.0, 24.0, 16.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	[@"+2.0" drawInRect:CGRectMake(2.0,  -8.0, 24.0, 16.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	...
	[@" 0.0" drawInRect:CGRectMake(2.0,  24.0, 24.0, 16.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	[@"-1.0" drawInRect:CGRectMake(2.0,  40.0, 24.0, 16.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
    [@"-2.0" drawInRect:CGRectMake(2.0,  56.0, 24.0, 16.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
    [@"-3.0" drawInRect:CGRectMake(2.0,  72.0, 24.0, 16.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
    [@"-4.0" drawInRect:CGRectMake(2.0,  88.0, 24.0, 16.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
    [@"-5.0" drawInRect:CGRectMake(2.0,  104.0, 24.0, 16.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
...
-(void)commonInit
{
	...
	text = [[GraphTextView alloc] initWithFrame:CGRectMake(0.0, 0.0, 32.0, 180.0)];
...
-(void)drawRect:(CGRect)rect
{
	...
	// Draw the grid lines
	DrawGridlines(context, 0.0, width,0);
}
